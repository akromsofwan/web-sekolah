                  ...
                  <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="nav-link" href="{{route('calonsiswa')}}">Calon Siswa</a>
                            <a class="nav-link" href="{{route('kegiatan')}}">Post Kegiatan</a>
                            <a class="nav-link" href="{{route('program')}}">Program Unggulan</a>
                            <a class="nav-link" href="{{route('pengumuman')}}">Pengumuman</a>
                            <a class="nav-link" href="{{route('gurusiswa')}}">Guru & Karyawan</a>
                        </div>
                    </li>
